...
//ritorna 4 se N � potenza di 4, altrimenti 2
unsigned int getFtButterflySize(int N);
//bandwidth va da f/bw a f*bw, il metodo ritorna bw
float filterQToBandwidth(float Q);
//ritorna power in banda compresa tra fMin e fMax: N � dimensione spettro (visto simmetrico), ma lui considera fino a N/2
